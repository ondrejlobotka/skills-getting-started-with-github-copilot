...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team drills and compete in interschool tournaments",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Training sessions focused on soccer skills and teamwork",
    ...
    "Math Olympiad": {
        "description": "Challenge your math skills with problem-solving and competition prep",
